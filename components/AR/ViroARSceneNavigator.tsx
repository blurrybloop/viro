...
export class ViroARSceneNavigator extends React.Component<Props, State> {
  ...
  arSceneNavigator = {
    ...
    startVideoRecording: this._startVideoRecording.bind(this),
    stopVideoRecording: this._stopVideoRecording.bind(this),
    takeScreenshot: this._takeScreenshot.bind(this),
    resetARSession: this._resetARSession.bind(this),
    setWorldOrigin: this._setWorldOrigin.bind(this),
